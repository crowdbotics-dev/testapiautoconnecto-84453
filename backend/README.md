...
## Project Structure
    ...
    ├── testapiautoconnecto_84453  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_84453`
...
2. Clone this repo and `cd testapiautoconnecto_84453`
